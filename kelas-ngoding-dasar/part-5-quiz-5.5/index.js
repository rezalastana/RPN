...
// ---------------------------------------
console.log(
    `${word1} ${second} ${third} ${fourth} ${fifth} ${sixth} ${seventh}`
);
console.log("=============================");
// ---------------------------------------
...
console.log(
    "Second Word: " + exampleFourthWord4 + ", with length: " + fourthWordLength
);
console.log(
    "Second Word: " + exampleFifthWord4 + ", with length: " + fifthWordLength
);
